#!/usr/bin/env python3
"""
Implement predictive models for glioblastoma detection using metabolomic data.
This script trains Random Forest, SVM, and Neural Network models on the preprocessed metabolomic data.
"""
...
os.makedirs('/home/ubuntu/glioblastoma_research/models/metabolomic', exist_ok=True)
os.makedirs('/home/ubuntu/glioblastoma_research/results/metabolomic', exist_ok=True)

print("Loading preprocessed metabolomic data...")
# Load the preprocessed data
expression_df = pd.read_csv('/home/ubuntu/glioblastoma_research/data/metabolomic/processed/metabolomics_scaled_expression.csv', index_col=0)
samples_info = pd.read_csv('/home/ubuntu/glioblastoma_research/data/metabolomic/processed/metabolomics_sample_info.csv')

# Prepare data for modeling
X = expression_df.T  # Transpose to get samples as rows
y = samples_info['group']  # Use the group column for classification
...
plt.title('Top 20 Important Features - Random Forest (Metabolomic Data)')
plt.tight_layout()
plt.savefig('/home/ubuntu/glioblastoma_research/results/metabolomic/rf_feature_importance.png', dpi=300)
...
plt.tight_layout()
plt.savefig('/home/ubuntu/glioblastoma_research/results/metabolomic/confusion_matrices.png', dpi=300)
...
plt.title('ROC Curves - Metabolomic Data Models')
plt.legend(loc="lower right")
plt.savefig('/home/ubuntu/glioblastoma_research/results/metabolomic/roc_curves.png', dpi=300)
...
results.to_csv('/home/ubuntu/glioblastoma_research/results/metabolomic/model_performance.csv', index=False)
print("Results saved to CSV file.")

# Save models
import pickle
with open('/home/ubuntu/glioblastoma_research/models/metabolomic/rf_model.pkl', 'wb') as f:
    pickle.dump(rf_model, f)
with open('/home/ubuntu/glioblastoma_research/models/metabolomic/svm_model.pkl', 'wb') as f:
    pickle.dump(svm_model, f)
with open('/home/ubuntu/glioblastoma_research/models/metabolomic/nn_model.pkl', 'wb') as f:
    pickle.dump(nn_model, f)

print("Models saved successfully.")
print("Metabolomic data modeling completed.")
